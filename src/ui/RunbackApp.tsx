  ...
  const renderModels = () => (
    <>
      ...
      <Section title="Erklärungen ohne Cloud">
        <Copy muted>
          Die lokalen Regeln entscheiden. Template steht immer bereit; eine
          geprüfte OpenRouter-Darstellung ersetzt sie erst nach erfolgreicher
          Rückgabe.
        </Copy>
      </Section>
      <ProseSettings />
