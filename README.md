...
**Aktueller Umfang: ausschließlich Dokumentation.** Dieses Repository enthält keinen App-Code, keine Build-Konfiguration und keine APK-Releases. Die Umsetzung beginnt erst mit einem neuen Auftrag.
