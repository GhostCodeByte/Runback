...
Heute → Trainingspläne verwaltet bearbeitbare Vorlagen für Krafttraining. Der Tab Einheiten zeigt Läufe und Krafttraining in einer nach Zeit sortierten Liste, filterbar nach Alle, Laufen und Krafttraining; für Krafteinheiten sind das die bis zu 500 zuletzt gespeicherten abgeschlossenen Einheiten mit absolvierten Sätzen und erfasstem Volumen, Planwerte werden nicht nachträglich als Ist-Werte ausgegeben. Heute → Muskelkarte bietet die Ansichten „Frische“ und „Gemeldeter Muskelkater“. Frische ist eine regionale Modellgröße aus Kraft- und Meldungsdaten, kein Readiness-, Gesundheits- oder Diagnosescore. Die Frischekarte bleibt bis zur bestandenen Hold-out-, Kalibrierungs-, Zeit-, Stabilitäts- und Ausfallprüfung unbekannt. Die optionale Android-Spracherfassung nutzt den nativen deutschen SpeechRecognizer, sofern das Gerät ihn bereitstellt; die strukturierte Auswertung erfolgt lokal über das deterministische Lexikon, Roh-Audio wird nicht gespeichert.

Beim ersten Start erscheint eine freiwillige Einrichtung: Ziel, Zeitbudget, Lauftage, Standardzweck, Dateiimport und optionale Aufzeichnungsberechtigungen. Schritte werden gespeichert; „Später“ beendet die Einrichtung. Unter Mehr → Einrichtung erneut öffnen lässt sie sich noch einmal starten. Import nutzt dieselbe Verarbeitung und Duplikaterkennung wie Mehr → Deine Daten.
